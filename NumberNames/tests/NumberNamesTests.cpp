...
TEST_F(NumberNamesSpellerFixture, fiveDigitsEndingAllZeros_shouldReturnNamedNumber) {
...
TEST_F(NumberNamesSpellerFixture, fiveDigitsWithoutIntermediateZeros_shouldReturnNamedNumber) {
